...
<b>버전 수정 페이지</b>
	<%
		...
		if (BoardList.size() == 1) {
			...
			System.out.println(BoardList.get(0).getCategoryCode());
			System.out.println(BoardList.get(0).getCategoryName());
		} else {
	...
	<table width="70%" cellpadding="0" cellspacing="0" border="0">
		<form name=board method=post>
			...
			<tr height="10">
				<td width=70>카테고리코드</td>
				<td><input name="categoryCode" type=edit
					value="<%=BoardList.get(0).getCategoryCode()%>" maxlength="100">
