...
<body>
	...
	<form name=board method=post>
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<%
				//게시판 목록 불러오기
				String sql = XMLParser.getSqlFromXML("selectVersion");
				ArrayList<Version> boardList = (ArrayList<Version>) VersionDao.selectVersion(sql);
				for (int i = 0; i < boardList.size(); i++) {
			%>
			<tr align="center" height="30">
				<td width="100"><input name="idx" type="radio"
					value="<%=boardList.get(i).getVersionCode()%>"> <%=boardList.get(i).getVersionCode()%></td>
				<td width="100"><%=boardList.get(i).getVersionName()%></td>
				<td width="100"><%=boardList.get(i).getForceYN()%></td>
			</tr>
			<%
				}
			%>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr align="center">
				<td><input type=button value="홈"
					...
					Onclick="javascript:pass('/MemoServer/jsp/InsertVersion.jsp')">
					<input type=button value="수정"
					Onclick="javascript:passForm('/MemoServer/jsp/ModifyVersion.jsp')">
					<input type=button value="삭제"
					Onclick="javascript:passForm('/MemoServer/jsp/DeleteVersion.jsp')">
				</td>
